...
var inventory = []
var spawnable_items = [
	{"type": "ROCK", "name": "ROCK", "effect": "", "texture": preload("res://Assets/items/item_4.png")},
	{"type": "WOOD", "name": "WOOD", "effect": "", "texture": preload("res://Assets/items/item_6.png")},
	{"type": "Consumible", "name": "Huevo", "effect": "Stamina", "texture": preload("res://Assets/Sprout Lands - Sprites - Basic pack/Objects/Egg_item.png")},
	{"type": "Casa", "name": "Gallinero", "effect": "Test", "texture": preload("res://Assets/Sprout Lands - Sprites - Basic pack/Objects/Free_Chicken_House.png")},
	{"type": "Objetos", "name": "Objetos", "effect": "Slot Boost", "texture": preload("res://Assets/Sprout Lands - Sprites - Basic pack/Objects/Basic_tools_and_meterials.png")},
]

var spawnable_objects = [
	{"path":preload("res://Scenes/objects/rock.tscn")},
	{"path":preload("res://Scenes/objects/wood.tscn")},
]
# Custom signals
